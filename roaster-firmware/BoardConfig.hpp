...
inline constexpr int BeanThermocoupleChipSelectPin = 6;
inline constexpr int FanThermocoupleChipSelectPin = 7;
inline constexpr int ThermocoupleClockPin = 5;
inline constexpr int ThermocoupleDataPin = 46;
inline constexpr int HeaterPwmPin = 14;
inline constexpr int FanPwmPin = 15;
inline constexpr int BdcFanServoPin = 16;
inline constexpr int ServiceUartTxPin = 17;
inline constexpr int ServiceUartRxPin = 18;
inline constexpr int AuxInputPin = 9;
#else
